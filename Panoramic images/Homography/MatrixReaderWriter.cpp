...
// Matrix Reader Implementation For ASIFT file formate where each row contain 
// x1 y1 x2 y2 
// except the first line wich contain numbers of the point pairs and i added # to the first line to ignore the frst line
