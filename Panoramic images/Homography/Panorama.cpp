...
int main(int argc, char* argv[])
{
	...
	//MatrixReaderWriter res = MatrixReaderWriter::(*image1, transformedImage, transformedImage(1));

	transformImage(image1, transformedImage, Mat::eye(3, 3, CV_32F), true);

	//    transformImage(image2,transformedImage,tr2,false);
	transformImage(image2, transformedImage, best_H.inv(), true);
